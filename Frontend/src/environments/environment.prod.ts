...
const apiOrigin = globalThis.location?.origin ?? 'https://98.83.135.32';
...
export const environment = {
  ...
  azure: {
    ...
    redirectUri: globalThis.location?.origin ?? 'https://98.83.135.32',
    postLogoutRedirectUri: globalThis.location?.origin ?? 'https://98.83.135.32',
