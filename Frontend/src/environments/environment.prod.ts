...
const apiOrigin = globalThis.location?.origin ?? 'https://54.158.212.213';
...
export const environment = {
  ...
  azure: {
    ...
    redirectUri: globalThis.location?.origin ?? 'https://54.158.212.213',
    postLogoutRedirectUri: globalThis.location?.origin ?? 'https://54.158.212.213',
